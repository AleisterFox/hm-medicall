...
<body>
    ...
    <main>
        ...
        <section id="servicio">
            <div class="container">
                ...
                <div class="servicio__descripcion">
                    ...
                    <div class="servicio__descripcion--info">
                        <div class="row">
                            <p class="info-name"> accusamus et iusto: </p>
                            <p class="info">1-2 Horas</p>
                        </div>
                        <div class="row">
                            <p class="info-name"> accusamus et iusto: </p>
                            <p class="info">General</p>
                        </div>
                        <div class="row">
                            <p class="info-name"> accusamus et iusto: </p>
                            <p class="info">1-2 Horas</p>
                    ...
                    <a href="contacto.php" class="button">Agenda tu cita</a>
                </div>
        ...
        <section id="servicio__explicacion">
            <div class="container">
                <div class="info">
