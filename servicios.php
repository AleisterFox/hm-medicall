...
<body>
    ...
    <main>
        ...
        <section id="paquetes">
            <h1 class="fadeInUp wow">Consulta Inicial</h1>
            <p class="fadeInUp wow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
            <a href="contacto.php" class="button"><i class="fas fa-star"></i>&nbsp;Agenda tu cita</a>
            <div class="container">
                <div class="servicio">
                    <h3>Lorem Ipsum</h3>
                    <figure>
                    ...
                    <a href="servicio.php" class="button">Leer más</a>
                </div>
